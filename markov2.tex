...
\begin{proof}
	...
	\begin{equation}
		...
		\end{aligned}
	\end{equation}
	Prva inkluzija vrijedi jer ako \( \omega \in  B(1, 4\varepsilon, M) \) i \( 4\varepsilon < \abs{X_{t_j}-X_{t_k}} \le \abs{X_{t_j}-X_u} + \abs{X_{t_k}-X_u} \)
	pa je barem jedan od sumanada zdesna \( > 2\varepsilon \). Ako \( \omega \in C_k \) iz \[ 4\varepsilon \le \abs{X_{t_j}-X_{t_k}} \le \abs{X_{t_j}-X_u} + \abs{X_u-X_v} + \abs{X_{t_k}-X_v}  \]
