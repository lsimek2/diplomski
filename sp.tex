...
\begin{definicija} \label{def:brown}
	...
	\begin{enumerate}[label=(\roman*)]
		\item je \( X_t \) normalno distribuirana s očekivanjem \( 0 \in \R^d \) i kovarijacijskom matricom \( tI \)  i \label{enum:browndef1}
...
skupa s \levy jevosti dovoljno za~\ref{enum:browndef2} po kasnijem teoremu~\ref{tm:aditgauss}.
