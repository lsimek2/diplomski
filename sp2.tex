...
\begin{komentar} \label{tmbdd-komentar}
	...
	\begin{itemize}
		...
		\item Obrazložimo zašto je familija mjera definiranih preko~\eqref{tmbdd-mjera} suglasna.
		      ...
		      \end{align}
		      gdje \( y_2' = y_1 + y_2 \), jednakost~\eqref{bddtm-konvform} dobijemo preko poznate formule za konvoluciju (npr.~\cite[\textsection 13.4,~(6)]{sarapa}). Naime, možemo ju u našem slučaju pisati
		      i kao:
		      \begin{equation}
			      \begin{aligned}
